...
@Component({
  selector: 'app-employee-timein-page',
  standalone: true,
  imports: [
    MatToolbarModule,
    MatIconModule,
  ...
  templateUrl: './employee-timein-page.component.html',
  styleUrl: './employee-timein-page.component.scss',
})
export class EmployeeTimeinPageComponent {
